...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('MOVIE GROUP ', url='t.me/CinemaPedikaGroup'),
                    InlineKeyboardButton('JOIN OUR MAIN CHANNEL', url=f'{TUTORIAL}')
                ]
                ]
            ...
            buttons = [
                [
                    InlineKeyboardButton('MOVIE GROUP ', url='t.me/Mo_Tech_YT'),
                    InlineKeyboardButton('JOIN OUR MAIN CHANNEL', url=f'{TUTORIAL}')
                ]
                ]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🖥️ JOIN OUR MAIN CHANNEL 🖥️', url=f'{TUTORIAL}')
                    ]
                    ]
